...
public class ElectronicsLocalServiceUtil {
	 ...
	 */
	public static Electronics createElectronics(long id) {
		return getService().createElectronics(id);
	}
	 ...
	 */
	public static Electronics deleteElectronics(long id)
		throws PortalException {

		return getService().deleteElectronics(id);
	}
	...
	public static Electronics fetchElectronics(long id) {
		return getService().fetchElectronics(id);
	}
	 ...
	 * @throws PortalException if a electronics with the primary key could not be found
	 */
	public static Electronics getElectronics(long id) throws PortalException {
		return getService().getElectronics(id);
	}
