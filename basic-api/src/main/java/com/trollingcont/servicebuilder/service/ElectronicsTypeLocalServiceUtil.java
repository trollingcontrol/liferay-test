...
public class ElectronicsTypeLocalServiceUtil {
	 ...
	 */
	public static ElectronicsType createElectronicsType(long productType) {
		return getService().createElectronicsType(productType);
	}
	 ...
	 */
	public static ElectronicsType deleteElectronicsType(long productType)
		throws PortalException {

		return getService().deleteElectronicsType(productType);
	}
	...
	public static ElectronicsType fetchElectronicsType(long productType) {
		return getService().fetchElectronicsType(productType);
	}
	 ...
	 * @throws PortalException if a electronics type with the primary key could not be found
	 */
	public static ElectronicsType getElectronicsType(long productType)
		throws PortalException {

		return getService().getElectronicsType(productType);
	}
