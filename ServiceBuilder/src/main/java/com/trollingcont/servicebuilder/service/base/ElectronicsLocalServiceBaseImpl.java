...
public abstract class ElectronicsLocalServiceBaseImpl
	...
	public Electronics createElectronics(long id) {
		return electronicsPersistence.create(id);
	}
	...
	public Electronics deleteElectronics(long id) throws PortalException {
		return electronicsPersistence.remove(id);
	}
	...
	public Electronics fetchElectronics(long id) {
		return electronicsPersistence.fetchByPrimaryKey(id);
	}
	...
	public Electronics getElectronics(long id) throws PortalException {
		return electronicsPersistence.findByPrimaryKey(id);
	}
