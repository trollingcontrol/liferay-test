...
public class ElectronicsTypePersistenceImpl
	...
	public ElectronicsType[] findByUuid_PrevAndNext(
		...
		ElectronicsType electronicsType = findByPrimaryKey(productType);
	 ...
	 */
	@Override
	public ElectronicsType create(long productType) {
		ElectronicsType electronicsType = new ElectronicsTypeImpl();

		electronicsType.setNew(true);
		electronicsType.setPrimaryKey(productType);
	 ...
	 */
	@Override
	public ElectronicsType remove(long productType)
		throws NoSuchElectronicsTypeException {

		return remove((Serializable)productType);
	}
	 ...
	 */
	@Override
	public ElectronicsType findByPrimaryKey(long productType)
		throws NoSuchElectronicsTypeException {

		return findByPrimaryKey((Serializable)productType);
	}
	 ...
	 */
	@Override
	public ElectronicsType fetchByPrimaryKey(long productType) {
		return fetchByPrimaryKey((Serializable)productType);
	}
