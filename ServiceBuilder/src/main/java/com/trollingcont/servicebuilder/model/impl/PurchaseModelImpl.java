...
public class PurchaseModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"datePurchased", Types.TIMESTAMP}, {"purchaseType", Types.BIGINT}
	};
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("purchaseType", Types.BIGINT);
	}

	public static final String TABLE_SQL_CREATE =
		"create table LS_Purchase (uuid_ VARCHAR(75) null,purchaseId LONG not null primary key,productId LONG,employeeId LONG,datePurchased DATE null,purchaseType LONG)";
	...
	public static Purchase toModel(PurchaseSoap soapModel) {
		...
		model.setPurchaseType(soapModel.getPurchaseType());
	...
	static {
		...
		attributeGetterFunctions.put("purchaseType", Purchase::getPurchaseType);
		attributeSetterBiConsumers.put(
			"purchaseType",
			(BiConsumer<Purchase, Long>)Purchase::setPurchaseType);
	...
	public Object clone() {
		...
		purchaseImpl.setPurchaseType(getPurchaseType());
	...
	public CacheModel<Purchase> toCacheModel() {
		...
		purchaseCacheModel.purchaseType = getPurchaseType();
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("purchaseType", _purchaseType);
	}
	...
	static {
		...
		columnBitmasks.put("purchaseType", 32L);
