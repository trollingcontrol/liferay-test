...
public class PurchasePersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newPurchase.setPurchaseType(RandomTestUtil.nextLong());
		...
		Assert.assertEquals(
			existingPurchase.getPurchaseType(), newPurchase.getPurchaseType());
	}
	...
	protected OrderByComparator<Purchase> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			...
			"employeeId", true, "datePurchased", true, "purchaseType", true);
	}
	...
	protected Purchase addPurchase() throws Exception {
		...
		purchase.setPurchaseType(RandomTestUtil.nextLong());
