...
public class ElectronicsTypePersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		Assert.assertEquals(
			existingElectronicsType.getProductType(),
			newElectronicsType.getProductType());
		Assert.assertEquals(
	...
	protected OrderByComparator<ElectronicsType> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"LS_ElectronicsType", "uuid", true, "productType", true, "name",
			true);
	}
	...
	public void testDynamicQueryByPrimaryKeyExisting() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.eq(
				"productType", newElectronicsType.getProductType()));
	...
	public void testDynamicQueryByPrimaryKeyMissing() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.eq(
				"productType", RandomTestUtil.nextLong()));
	...
	public void testDynamicQueryByProjectionExisting() throws Exception {
		...
		dynamicQuery.setProjection(
			ProjectionFactoryUtil.property("productType"));

		Object newProductType = newElectronicsType.getProductType();

		dynamicQuery.add(
			RestrictionsFactoryUtil.in(
				"productType", new Object[] {newProductType}));

		List<Object> result = _persistence.findWithDynamicQuery(dynamicQuery);

		Assert.assertEquals(1, result.size());

		Object existingProductType = result.get(0);
	...
	public void testDynamicQueryByProjectionMissing() throws Exception {
		...
		dynamicQuery.add(
			RestrictionsFactoryUtil.in(
				"productType", new Object[] {RandomTestUtil.nextLong()}));
