...
public class ElectronicsPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newElectronics.setProductType(RandomTestUtil.nextLong());
		...
		Assert.assertEquals(
			existingElectronics.getProductType(),
			newElectronics.getProductType());
		Assert.assertEquals(
	...
	protected OrderByComparator<Electronics> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			"LS_Electronics", "uuid", true, "id", true, "name", true,
			"productType", true, "amount", true, "present", true, "archived",
	...
	protected Electronics addElectronics() throws Exception {
		...
		electronics.setProductType(RandomTestUtil.nextLong());
