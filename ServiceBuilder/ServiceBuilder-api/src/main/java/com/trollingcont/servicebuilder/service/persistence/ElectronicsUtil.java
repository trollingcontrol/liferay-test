...
public class ElectronicsUtil {
	 ...
	 */
	public static Electronics create(long productId) {
	 ...
	 * @throws NoSuchElectronicsException if a electronics with the primary key could not be found
	 */
	public static Electronics remove(long productId)
		throws com.trollingcont.servicebuilder.exception.
			NoSuchElectronicsException {
	 ...
	 * @throws NoSuchElectronicsException if a electronics with the primary key could not be found
	 */
	public static Electronics findByPrimaryKey(long productId)
		throws com.trollingcont.servicebuilder.exception.
			NoSuchElectronicsException {
	 ...
	 */
	public static Electronics fetchByPrimaryKey(long productId) {
