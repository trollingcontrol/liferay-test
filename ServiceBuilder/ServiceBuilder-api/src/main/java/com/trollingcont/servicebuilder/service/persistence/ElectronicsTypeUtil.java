...
public class ElectronicsTypeUtil {
	 ...
	 */
	public static ElectronicsType create(long productTypeId) {
	 ...
	 * @throws NoSuchElectronicsTypeException if a electronics type with the primary key could not be found
	 */
	public static ElectronicsType remove(long productTypeId)
		throws com.trollingcont.servicebuilder.exception.
			NoSuchElectronicsTypeException {
	 ...
	 * @throws NoSuchElectronicsTypeException if a electronics type with the primary key could not be found
	 */
	public static ElectronicsType findByPrimaryKey(long productTypeId)
		throws com.trollingcont.servicebuilder.exception.
			NoSuchElectronicsTypeException {
	 ...
	 */
	public static ElectronicsType fetchByPrimaryKey(long productTypeId) {
