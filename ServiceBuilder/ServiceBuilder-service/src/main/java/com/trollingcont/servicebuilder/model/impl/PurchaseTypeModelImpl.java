...
import com.trollingcont.servicebuilder.model.PurchaseTypeModel;
import com.trollingcont.servicebuilder.model.PurchaseTypeSoap;
...
/**
 * The base model implementation for the PurchaseType service. Represents a row in the &quot;LS_PurchaseType&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class PurchaseTypeModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "LS_PurchaseType";
	...
	public static final String TABLE_SQL_CREATE =
		"create table LS_PurchaseType (uuid_ VARCHAR(75) null,purchaseTypeId LONG not null primary key,name VARCHAR(100) null)";

	public static final String TABLE_SQL_DROP = "drop table LS_PurchaseType";

	public static final String ORDER_BY_JPQL =
		" ORDER BY purchaseType.purchaseTypeId ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY LS_PurchaseType.purchaseTypeId ASC";
	...
	private static Function<InvocationHandler, PurchaseType>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			PurchaseType.class.getClassLoader(), PurchaseType.class,
			ModelWrapper.class);

		try {
			Constructor<PurchaseType> constructor =
				(Constructor<PurchaseType>)proxyClass.getConstructor(
