...
public class ProductTypePersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByProductName;
	private FinderPath _finderPathWithoutPaginationFindByProductName;
	 ...
	 */
	@Override
	public List<ProductType> findByProductName(
		String name, int start, int end) {

		return findByProductName(name, start, end, null);
	}
	...
	public List<ProductType> findByProductName(
		...
		return findByProductName(name, start, end, orderByComparator, true);
	}
	...
	public List<ProductType> findByProductName(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByProductName;
				finderArgs = new Object[] {name};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByProductName;
		...
		if (list == null) {
			...
			if (name.isEmpty()) {
				sb.append(_FINDER_COLUMN_PRODUCTNAME_NAME_3);
			}
			else {
				bindName = true;

				sb.append(_FINDER_COLUMN_PRODUCTNAME_NAME_2);
			}
	...
	public ProductType findByProductName_First(
		...
		ProductType productType = fetchByProductName_First(
	...
	public ProductType fetchByProductName_First(
		...
		List<ProductType> list = findByProductName(
	...
	public ProductType findByProductName_Last(
		...
		ProductType productType = fetchByProductName_Last(
			name, orderByComparator);
	...
	public ProductType fetchByProductName_Last(
		...
		int count = countByProductName(name);
	...
	public ProductType[] findByProductName_PrevAndNext(
		...
		try {
			...
			array[0] = getByProductName_PrevAndNext(
				session, productType, name, orderByComparator, true);

			array[1] = productType;

			array[2] = getByProductName_PrevAndNext(
				session, productType, name, orderByComparator, false);
	...
	protected ProductType getByProductName_PrevAndNext(
		Session session, ProductType productType, String name,
		OrderByComparator<ProductType> orderByComparator, boolean previous) {
	...
	private static final String _FINDER_COLUMN_PRODUCTNAME_NAME_2 =
		"productType.name = ?";

	private static final String _FINDER_COLUMN_PRODUCTNAME_NAME_3 =
		"(productType.name IS NULL OR productType.name = '')";
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindByProductName = _createFinderPath(
		...
		_finderPathWithoutPaginationFindByProductName = _createFinderPath(
