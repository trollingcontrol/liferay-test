...
public class PurchasePersistenceImpl
	 ...
	 */
	@Override
	public List<Purchase> findByEmployee(long employeeId) {
	 ...
	 */
	@Override
	public List<Purchase> findByEmployee(long employeeId, int start, int end) {
	 ...
	 */
	@Override
	public List<Purchase> findByEmployee(
		long employeeId, int start, int end,
		OrderByComparator<Purchase> orderByComparator) {

		return findByEmployee(employeeId, start, end, orderByComparator, true);
	}
	...
	public List<Purchase> findByEmployee(
		...
		if (list == null) {
			...
			sb.append(_FINDER_COLUMN_EMPLOYEE_EMPLOYEEID_2);
	...
	public Purchase findByEmployee_First(
		...
		Purchase purchase = fetchByEmployee_First(
	...
	public Purchase fetchByEmployee_First(
		...
		List<Purchase> list = findByEmployee(
	...
	public Purchase findByEmployee_Last(
		...
		Purchase purchase = fetchByEmployee_Last(employeeId, orderByComparator);
	...
	protected Purchase getByEmployee_PrevAndNext(
	...
	private static final String _FINDER_COLUMN_EMPLOYEE_EMPLOYEEID_2 =
		"purchase.employeeId = ?";
